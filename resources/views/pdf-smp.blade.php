...
<body>
    ...
    <div class="col-md-10 my-5 mx-auto">
                            ...
                            <th>
                                <div class="img-profile asu">
                                    ...
                                    <img style="height: 150px; width: 150px"
                                        src="file_ppdb/smp/{{ $id }}/{{ $file_foto }}">
                                </div>
                            </th>
                        </tr>
                    </table>
        ...
        <div class="card border-success mb-2">
            <div class="card-header">C. Data Periodik Calon Peserta Didik</div>
            <div class="card-body text-dark">
                <p class="card-text">
                    <p>Tinggi : {{ $tinggi }}</p>
                    <p>Berat Badan : {{ $berat_badan }}</p>
                    <p>Jarak Sekolah : {{ $jarak_sekolah }}</p>
                    <p>Waktu Tempuh: {{ $waktu_tempuh }}</p>
                    <p>Anak Ke- {{ $anak_ke }}</p>
                </p>
            </div>
        </div>
