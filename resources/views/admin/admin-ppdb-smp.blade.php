...
<script src="{{ asset('js/admin/ppdb-smp.js') }}"></script>
@endsection
                    ...
                    <div class="card mt-4">
                        <div class="card card-primary">
                            <div class="card-header ">
                                <h3 class="card-title ">Data Calon PPDB SMP</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="change_status"
                                        id="buka" value="1">
                                ...
                                <table class="table table-bordered" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-sm">Asal Sekolah</th>
                                            <th class="text-sm">Kelamin</th>
                                            <th class="text-sm">NISN</th>
                                            <th class="text-sm">NIK</th>
                                            <th class="text-sm">Tempat, Tanggal Lahir</th>
                                            <th class="text-sm">Alamat</th>
                                            <th class="text-sm">No. Hp/Telp</th>
                                            <th class="text-sm">Nama Ayah</th>
                                            <th class="text-sm">Nama Ibu</th>
                                            <th class="text-sm">File SHUS</th>
                                            <th class="text-sm">File KK</th>
                                            <th class="text-sm">File Foto</th>
                                            <th class="text-sm">File KIP/KPS</th>
                    ...
                    <div class="card mt-4">
                        <div class="card card-secondary">
                            <div class="card-header text-white">
                                <h3 class="card-title ">Postingan Berita Pengumuman PPDB-SMP</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="col-12" id="pengumuman-ppdb-smp">
                                <div class="content">
                                    <div class="card card-secondary">
                                        <div class="card-header text-white">
                                          View Pengumuman PPDB-SMP
                                        </div>
                                        <div class="card-body">
        ...
        <div class="modal-dialog" role="document" style="max-width: 1000px !important">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Berita Pengumuman PPDB-SMP</h5>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 my-4">
                                <label for="judul">Judul Pengumuman PPDB-SMP</label>
